...
class __TwigTemplate_b2f39526e29317245380e94458b6a10b845c2daf2317ff502465c50329254797 extends \Twig\Template
{
  ...
  ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["rendered_item"]) {
            // line 19
            echo "    ";
            echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->renderVar($this->env->getExtension('Drupal\flag\TwigExtension\FlagCount')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($context["rendered_item"]), "html", null, true));
            echo "
  ";
        }
...
";
    ...
    {
        return new Source("", "modules/contrib/views_slideshow/modules/views_slideshow_cycle/templates/views-slideshow-cycle-main-frame-row.html.twig", "/home/vietquang/public_html/modules/contrib/views_slideshow/modules/views_slideshow_cycle/templates/views-slideshow-cycle-main-frame-row.html.twig");
    }
}
